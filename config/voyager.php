...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['translations','failed_jobs','permissions','user_roles','migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings'],
        ],
