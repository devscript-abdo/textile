                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-7">
                                        <div class="product-gallery">
                                            <figure class="product-main-image">
                                                ...
                                                <img id="product-zoom" src="{{asset('assets/images/products/single/fullwidth/3.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/fullwidth/3-big.jpg')}}" alt="product image">
                                            ...
                                            <div id="product-zoom-gallery" class="product-image-gallery max-col-6">
                                                <a class="product-gallery-item" href="#" data-image="{{asset('assets/images/products/single/fullwidth/1.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/fullwidth/1-big.jpg')}}">
                                                    <img src="{{asset('assets/images/products/single/fullwidth/1-small.jpg')}}" alt="product side">
                                                </a>

                                                <a class="product-gallery-item" href="#" data-image="{{asset('assets/images/products/single/fullwidth/2.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/fullwidth/2-big.jpg')}}">
                                                    <img src="assets/images/products/single/fullwidth/2-small.jpg" alt="product cross">
                                                </a>

                                                <a class="product-gallery-item active" href="#" data-image="{{asset('assets/images/products/single/fullwidth/3.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/fullwidth/3-big.jpg')}}">
                                                    <img src="{{asset('assets/images/products/single/fullwidth/3-small.jpg')}}" alt="product with model">
                                                </a>

                                                <a class="product-gallery-item" href="#" data-image="{{asset('assets/images/products/single/fullwidth/4.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/fullwidth/4-big.jpg')}}">
                                                    <img src="{{asset('assets/images/products/single/fullwidth/4-small.jpg')}}" alt="product back">
                                                </a>
                                    ...
                                    <div class="col-md-6 col-lg-5">
                                        <div class="product-details">
                                            <h1 class="product-title">Beige ring handle circle cross body bag</h1><!-- End .product-title -->
                                            ...
                                            <div class="details-filter-row details-row-size">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="{{asset('assets/images/products/single/fullwidth/1-thumb.jpg')}}" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{asset('assets/images/products/single/fullwidth/2-thumb.jpg')}}" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{asset('assets/images/products/single/fullwidth/3-thumb.jpg')}}" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{asset('assets/images/products/single/fullwidth/4-thumb.jpg')}}" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
