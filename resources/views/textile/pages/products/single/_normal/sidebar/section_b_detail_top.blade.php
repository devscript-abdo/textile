                                    ...
                                    <div class="col-md-6">
                                        <div class="product-gallery">
                                            ...
                                            <div id="product-zoom-gallery" class="product-image-gallery">
                                                <a class="product-gallery-item active" href="#" data-image="{{asset('assets/images/products/single/sidebar-gallery/1.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/sidebar-gallery/1-big.jpg')}}">
                                                    <img src="{{asset('assets/images/products/single/sidebar-gallery/1-small.jpg')}}" alt="product side">
                                                </a>

                                                <a class="product-gallery-item" href="#" data-image="{{asset('assets/images/products/single/sidebar-gallery/2.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/sidebar-gallery/2-big.jpg')}}">
                                                    <img src="{{asset('assets/images/products/single/sidebar-gallery/2-small.jpg')}}" alt="product cross">
                                                </a>

                                                <a class="product-gallery-item" href="#" data-image="{{asset('assets/images/products/single/sidebar-gallery/3.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/sidebar-gallery/3-big.jpg')}}">
                                                    <img src="{{asset('assets/images/products/single/sidebar-gallery/3-small.jpg')}}" alt="product with model">
                                                </a>

                                                <a class="product-gallery-item" href="#" data-image="{{asset('assets/images/products/single/sidebar-gallery/4.jpg')}}" data-zoom-image="{{asset('assets/images/products/single/sidebar-gallery/4-big.jpg')}}">
