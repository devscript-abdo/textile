        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="product-body product-action-inner">
                    ...
                    <h3 class="product-title"><a href="{{route('products.single','prouct-alpha')}}">Brown paperbag waist pencil skirt</a></h3><!-- End .product-title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="product-body product-action-inner">
                    ...
                    <h3 class="product-title"><a href="{{route('products.single','prouct-alpha')}}">Dark yellow lace cut out swing dress</a></h3><!-- End .product-title -->
